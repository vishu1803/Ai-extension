...
- Name: architecture.spec.ts >> Canonical Context Architecture Invariants >> Invariant 7: Streaming updates modify existing message instead of creating duplicates
- Location: src\__tests__\e2e\architecture.spec.ts:174:7
